...
const alphanumWhitelist =
  "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZàáâãäåéêëìíîïóôõöòøùúûüýÿÀÁÂÃÄÅÉÊËÌÍÎÏÓÔÕÖÒØÙÚÛÜÝŸ";
...
export const ocr = async (
  ...
  for (let i = 0; i < base64Images.length; i++) {
    ...
    const [namesCtx, scoresCtx] = await splitImage(
      imgData.substring(imgData.indexOf("base64,") + 7)
    );
